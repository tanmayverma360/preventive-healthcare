  ...
  return (
    <div className="flex flex-col">
      ...
      <input
        ...
        value={value}
        onChange={onChange}
        // Add dark:text-gray-100 here
        className="mt-1 px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white/60 dark:bg-black/30 backdrop-blur-sm focus:ring-2 focus:ring-[#39e240] outline-none transition-all duration-300 dark:text-gray-100"
      />
    </div>
  );
}
